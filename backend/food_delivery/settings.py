...
if not DEBUG:
    ...
    print(f"--- Attempting to connect to database with URL: {db_from_env} ---")
    DATABASES = {
...
STATIC_URL = '/static/'
# Following settings only apply in production
if not DEBUG:
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = True # For development only. In production, use a specific list.
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
