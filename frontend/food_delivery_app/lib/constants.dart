...
const String _localIpAddress = kIsWeb ? '127.0.0.1' : '10.4.45.171';

const String baseUrl = 'http://10.4.45.171:8000/api';
const String baseWebsocketUrl = 'ws://$_localIpAddress:8000';
