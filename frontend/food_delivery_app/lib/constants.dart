...
const String _localIpAddress = kIsWeb ? '127.0.0.1' : '10.4.45.150';

const String baseUrl = 'http://10.4.45.150:8000/api';
const String baseWebsocketUrl = 'ws://10.4.45.150:8000';
